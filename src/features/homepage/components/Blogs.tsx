    ...
    <div className="container mx-auto">
      ...
      <div className="flex flex-wrap m-auto gap-5 justify-center mb-5">
        {BLOGS.map((blog, index) => (
          <Card
            key={index}
            className="w-[680px] h-96 justify-center items-center gap-5 flex cursor-pointer hover:bg-slate-100"
          >
            <img className="rounded-2xl p-4" src={blog.image} alt="" />
            <div className="flex-col justify-center items-start gap-2 flex">
              ...
              <div className="flex-col justify-center items-start gap-11 flex">
                <div className="flex-col justify-center items-start gap-5 flex">
                  ...
                  <div className="w-64 h-24 text-sky-900 text-sm font-normal">
                    {blog.description}
                  </div>
                </div>
